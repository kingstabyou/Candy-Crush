...
var EVENT_TYPES_TO_LOG = {
  ...
  keydown: true,
  NameLocation: true,
  LocationAlldaycheck: true,
  AlldaycheckStartDate: true,
  StartdateEnddate: true,
  EnddateRecselect: true,
  RecselectRecenddate: true,
  StartdateError: true,
  Enddaterror: true,
  Repeatenddateerror: true,
  AlldayError: true,
};
...
function sendNetworkLog(uid, time, name, target, info, state, version) {
  var formid = "1vXHZtD24sZw2CeJp-Zda-J3VY61MEvLBc0c3A15Mork";
  var data = {
    "entry.1876272358": uid,
    "entry.2009149663": time,
    "entry.26885635": name,
    "entry.1077265455": target,
    "entry.1416037186": info,
    "entry.109964048": state,
    "entry.2054223759": version,
  };
  var params = [];
  for (key in data) {
