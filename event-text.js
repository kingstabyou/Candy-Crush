...
// End time must come after start time   $('#all-day-event-checkbox').is(':checked')
...
function getYearlyRepeatingString(arr) {
  ...
  eventString +=
    arr[arr.length - 1] + " on the corresponding day of the month(s) ";
  return eventString;
}
...
function getEventText() {
  ...
  var eventString =
    "Event created: " + eventName + " at " + eventLocation + ",";
  ...
  if (repeatOption == "none") {
    ...
    if (frequencyOption == "daily") {
      ...
      eventString +=
        ...
        frequency +
        " week(s) " +
        getWeeklyRepeatingString(repeatingUnits);
      ...
      eventString +=
        ...
        frequency +
        " month(s) " +
        getMonthlyRepeatingString(repeatingUnits);
    } else {
      // yearly
      ...
      eventString +=
        ...
        frequency +
        " year(s) " +
        getYearlyRepeatingString(repeatingUnits);
    }
  }
